...
class FinanceManager:
    def __init__(self, master):
        ...
        master.geometry('{}x{}'.format(400, 600))  # Set window size
        ...
        self.publisher_label = tk.Label(master, text="Techstacity Apps. 2023", font=("Arial", 16), bg="#eee")
        ...
        self.publisher_label.grid(row=6, column=1, padx=20, pady=20)
